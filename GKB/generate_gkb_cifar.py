...
from cifar import Cifar10AttrId
import moco.builder
...
def build_dataloader(args):
    ...
    dataset = Cifar10AttrId(root=args.root, train=True, transform=val_transforms)
...
def main(args):
    ...
    eval_path = f'gkb/cifar/{args.num_attr}/checkpoint_0299.pth.tar'
    ...
    pkl.dump(d, open(f'gkb/cifar/{args.num_attr}/gkb.pkl', 'wb'))


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--root', default='/dataset/cifar/', type=str)
    ...
    parser.add_argument('--num_attr', default=9, type=int)
